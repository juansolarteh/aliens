...
public interface Globales {
    ...
    public static final int VELOCIDAD_DEL_JUEGO = 60;
    public static final int VELOCIDAD_DEL_PROYECTILES = 10;
    
    public final String[] ALIEN_IMG = {"src/imagenes/ufo1.png", "src/imagenes/ufo-bonito.png","src/imagenes/ufo-bonito.png","src/imagenes/UFO-32.png","src/imagenes/UFO-32.png"};
